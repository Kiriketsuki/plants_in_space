    ...
    <div class="w-screen h-screen flex flex-col items-center justify-center">
        ...
        <div class="main-content flex flex-col items-center justify-start z-0 w-screen h-screen gap-20 pt-[15vh]">
            ...
            <p class="text-white font-code text-4xl text-center w-[55vw]">
                ...
                >. This approach aims to redefine how we cultivate plants, using sound as a nurturing force that shapes plant growth in ways that could ultimately sustain human life beyond Earth. <br />
                <br />
                <br />
                <span class="text-sm">
                    Check out the code on
                    <a
                        href="https://github.com/Kiriketsuki/plants_in_space"
                        class="space-text"
                        >GitHub</a
                    >!
                </span>
